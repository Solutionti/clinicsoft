        ...
        <div class="col-lg-7 mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Crecimiento mes a mes</h6>
              <p class="text-sm mb-0">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold">20% mas</span> en 2025
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
          ...
          <div class="card card-carousel overflow-hidden h-100 p-0">
            <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
              <div class="carousel-inner border-radius-lg h-100">
                <div class="carousel-item h-100 active" style="background-image: url('../public/img/theme/carousel-3.jpg');
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                      <i class="ni ni-camera-compact text-dark opacity-10"></i>
                    </div>
                    <h5 class="text-white mb-1">Conoce mas a cerca de nuestra empresa GoFuture y las  actualizaciones.</h5>
                    <p>Descubre por que trabajar con nosotros es mucho mucho mas beneficioso.</p>
                  </div>
                </div>
                <!-- <div class="carousel-item h-100" style="background-image: url('../public/img/theme/carousel-2.jpg');
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                ...
                <!-- <div class="carousel-item h-100" style="background-image: url('../public/img/theme/carousel-3.jpg');
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                      <i class="ni ni-trophy text-dark opacity-10"></i>
                    </div>
                    <h5 class="text-white mb-1">Mira que estamos desarollando en estos momentos</h5>
                    <p>Aqui podras visualizar el tablero de actualzaciones y en que estamos trabajando.</p>
                  </div>
                </div> -->
              </div>
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Pacientes Nuevos</h6>
              </div>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center ">
                <tbody>
                  <?php foreach($pacientesn->result() as $pacientesnue){ ?>
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                          <img src="<?php echo base_url();?>public/img/theme/logo.png" width="34px;">
                        </div>
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0"><?php echo $pacientesnue->apellido." ".$pacientesnue->nombre; ?></p>
                          <h6 class="text-sm mb-0">1110542802</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        <p class="text-xs font-weight-bold mb-0">Dirección</p>
                        <h6 class="text-sm mb-0">Cr 26 # 67 - 30 </h6>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        <p class="text-xs font-weight-bold mb-0">Telefono</p>
                        <h6 class="text-sm mb-0">3227659534</h6>
                      </div>
                    </td>
                    <td class="align-middle text-sm">
                      <div class="col text-center">
                        <p class="text-xs font-weight-bold mb-0">Fecha:</p>
                        <h6 class="text-sm mb-0"><?php echo date("d-m-Y"); ?></h6>
                      </div>
                    </td>
                  </tr>
                <?php } ?>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs"><?php echo $pacientes->pacientes; ?> pacientes, <span class="font-weight-bold">346 historial fisico</span></span>
                    </div>
                  </div>
                  <div class="d-flex">
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs"><?php echo $pacientes->pacientes; ?> pacientes, <span class="font-weight-bold">15 laboratorio</span></span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs"><?php echo $pacientes->pacientes; ?> pacientes, <span class="font-weight-bold">40 patologia</span></span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs"><?php echo $pacientes->pacientes; ?> pacientes, <span class="font-weight-bold">40 ecografias</span></span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
