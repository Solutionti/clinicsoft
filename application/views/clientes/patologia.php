...
<head>
    ...
    <title>Patología | ClinicSoft</title>
    ...
    <style>
        ...
        .result-card:hover {
            ...
            border-color: #fb6340; /* Color naranja (warning) para patología */
        }

        .result-card .icon-box {
            background: rgba(251, 99, 64, 0.1); /* Naranja transparente */
            width: 50px;
            height: 50px;
            border-radius: 12px;
            display: flex;
        ...
        /* Banner de cabecera temático (Microscopio) */
        .header-banner {
            background-image: url('https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80');
      ...
      <div class="container-fluid py-1 px-3 mt-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active font-weight-bold" aria-current="page">Resultados de Patología</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0" style="font-size: 1.5rem;">Mis Exámenes</h6>
        </nav>
    ...
    <div class="card shadow-lg mx-4 mt-4 mb-5">
      <div class="card-body p-4">
        ...
        <div class="row align-items-center mb-4 pb-3 border-bottom">
          <div class="col-auto">
            <div class="icon-shape bg-gradient-warning text-white rounded-circle shadow-sm text-center d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
              <i class="fas fa-microscope fs-3"></i>
            </div>
          </div>
          <div class="col">
            <h4 class="mb-0 text-dark">Exámenes de Patología y Biopsias</h4>
        ...
        <div class="row">
          ...
          <?php if($patologia->num_rows() > 0): ?>
            <?php foreach($patologia->result() as $patologias){ ?>
                ...
                <div class="result-card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                      ...
                      <span class="badge bg-success-soft text-success border border-success px-2 py-1 rounded-pill" style="font-size: 0.65rem;">
                        <i class="fas fa-check-circle me-1"></i> Listo
                      </span>
                    </div>
                    
                    <h6 class="text-dark font-weight-bolder text-uppercase text-sm mb-1 mt-2 text-truncate" title="<?php echo $patologias->titulo; ?>">
                        <?php echo $patologias->titulo; ?>
                    </h6>
                    
                    <div class="d-flex align-items-center text-muted text-xs mb-3">
                      <i class="far fa-calendar-alt me-2"></i>
                      <span>Emitido el: <strong><?php echo date('d/m/Y', strtotime($patologias->fecha)); ?></strong></span>
                    </div>
                    
                    <?php 
                        $ruta_documento = "";
                        if($patologias->tp_documento == "patologia"){
                            $ruta_documento = base_url()."public/patologia/".$patologias->url_documento;
                        } else {
                            $ruta_documento = base_url()."public/documentos/".$patologias->url_documento;
                        }
                    ?>
                    <a target="_blank" href="<?php echo $ruta_documento; ?>" 
                       class="btn btn-download w-100 mb-0 d-flex justify-content-center align-items-center">
          ...
          <?php else: ?>
            <div class="col-12 text-center py-5">
                ...
                <h5 class="text-muted">Aún no hay estudios de patología disponibles</h5>
                <p class="text-sm">Tus informes histopatológicos o citológicos aparecerán aquí cuando estén listos.</p>
            </div>
          <?php endif; ?>
