...
$route['administracion/pdfecografiaorden/(:num)/(:num)/(:num)'] = 'administrador/historiaclinica/formatoEcografiaOrdenes/$1/$2/$3';
$route['administracion/pdftomografiaorden/(:num)/(:num)/(:num)'] = 'administrador/historiaclinica/formatoTomografiaOrdenes/$1/$2/$3';
$route['administracion/pdfresonanciaorden/(:num)/(:num)/(:num)'] = 'administrador/historiaclinica/formatoResonanciaOrdenes/$1/$2/$3';
$route['administracion/pdfpatologiaorden/(:num)/(:num)'] = 'administrador/historiaclinica/formatoPatologiaOrdenamiento/$1/$2';
$route['administracion/pdfmedicamentosorden/(:num)/(:num)'] = 'administrador/historiaclinica/formatoMedicamentosOrdenamiento/$1/$2';
