<?php
	...
	if($cajas != false){
		...
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("B6"), 'B'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("B6"), 'C'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("B6"), 'D'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("B6"), 'E'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("B6"), 'F'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("B6"), 'G'.($base));
				...
				for ($i=0; $i < sizeof($ingresos_comision); $i++) {
					if($cajas[$QQ]['usuario'] == $ingresos_comision[$i]['usuario']){
						if($state_user){
							...
							$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("A6"), 'B'.($base));
							$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("A6"), 'C'.($base));
							$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("A6"), 'D'.($base));
	...
	$base = $base + 1;
	/*******TOTALES*/
	$valor__ = ($Global_Tot_ingresos+$Global_Lab_Tot_ingresos)-$Global_Tot_monto;
	...
	if($valor__<0){
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("F6"), 'E'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("F6"), 'F'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("F6"), 'G'.($base));
	}else if($valor__>0){
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("E6"), 'E'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("E6"), 'F'.($base));
		$objPHPExcel->getActiveSheet()->duplicateStyle($objPHPExcel->getActiveSheet()->getStyle("E6"), 'G'.($base));
	}
	...
	if($valor__==0){
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('D'.($base), "Los ingresos no cubren los gastos " );
	}
	$base = $base + 1;
